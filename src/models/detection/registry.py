...
# ---------------------------------------------------------------------------
# Internal registry: prefix → model class
# Ordered longest-first so "yolov10" matches before "yolov1"
# ---------------------------------------------------------------------------
...
def get_model(
    ...
    **kwargs: Any,
    ...
    return model_cls(config=config, device=device, checkpoint_path=checkpoint_path, **kwargs)
