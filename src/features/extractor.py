...
class FeatureExtractor:
    ...
    def extract(
        ...
        speeds = np.array([v["speed"] for v in vehicles], dtype=float) if n else np.array([])
        directions = np.array([v["direction"] for v in vehicles], dtype=float) if n else np.array([])
